...
export class ContractResponseDto {
  ...
  @ApiProperty({
    example: 'Contratação de empresa especializada para serviços...',
  })
  objeto: string;

  @ApiProperty({
    example: '2014-05-23T12:00:00.000Z',
    required: false,
    nullable: true,
  })
  ...
  @ApiProperty({
    example: '2015-05-22T12:00:00.000Z',
    required: false,
    nullable: true,
  })
  ...
  @ApiProperty({
    example: 'Ministério da Educação',
    required: false,
    nullable: true,
  })
